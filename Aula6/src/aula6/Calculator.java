...
public class Calculator extends JFrame {
    private JPanel panelRoot, panelButtons, panelFunctions, panelNumbers;
    ...
    public Calculator() {
        ...
        JMenu menuArquivo = new JMenu("Edit");
        JMenu menuEditar = new JMenu("View");
        JMenu menuSobre = new JMenu("Help");
        ...
        //Construção da GUI
        panelRoot = new JPanel(new GridLayout(2, 1, 10, 10));
        //GridLayout gridLayoutRoot = new GridLayout(2, 1, 10, 10);
        //panelRoot.setLayout(gridLayoutRoot);
        
        textFieldDisplay = new JTextField();
        panelRoot.add(textFieldDisplay);
        
        panelFunctions = new JPanel(new GridLayout(4, 3, 10, 10));
        
        panelNumbers = new JPanel(new GridLayout(4, 4, 10, 10));
